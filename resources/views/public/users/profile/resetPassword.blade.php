...
<section>
    ...
    <div class="row p-3">
        <div class="col-12">
            ...
            <p>
                <input id="password-field" type="password" name="passOld" class="inputform viennhat" placeholder="Nhập mật khẩu">
        ...
        <div class="col-12">
            ...
            <p>
                <input type="password" name="re_password" class="inputform viennhat" id="password2"  placeholder="Nhập lại mật khẩu mới"/>
