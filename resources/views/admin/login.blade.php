...
<head>
	...
	<link rel="stylesheet" href="{{asset('public/admin/css/header.css')}}">
	<link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
	<link rel="stylesheet" href="{{asset('public/admin/css/log.css')}}">
    ...
    <div class="login-container">
        <div class="pt-5 text-center">
            <div class="logo fs-1 text-white mt-4">
                <img src="{{asset('public/images/logomevivumoi.png')}}" class="img-fluid" width="300" height="60" alt="">
            </div>
