...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Mulish:wght@200;300;400;600;700;900&display=swap"
        rel="stylesheet">
...
<body>
    <header id="header" class="background-primary">
        <div class="container">
            ...
            <div id="" class="search search-top">
                <form action="{{ route('search.show') }}" method="get">
                    <div class="input-group mb-3 search-input">
                        ...
                        <input type="text" class="form-control" placeholder="Tìm kiếm..." name="keyword" data-url="
                        {{ route('search.suggest') }}" onkeyup="showSearchSuggest(this)" autocomplete="off">
                    ...
                    <div class="show-search-suggest">
                        ...
                        <div>
                            <button class="btn btn-primary btn-rounded" type="submit">Hiền thị toàn bộ kết quả</button>
                        </div>
                    </div>
                </form>
            </div>
