                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class="selectpicker form-control selectCategory nhomhang" name="category_parent"
                                                required data-placeholder="Chọn nhóm ngành hàng" data-type="megaParent">
                                                <option></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class="selectpicker form-control selectCategory nhomsp" name="category_parent"
                                                required data-placeholder="Chọn nhóm sản phẩm" data-type="parent">
                                                <option></option>
                                                @if ( $product->productCategory->typeof_category == 2 )
                                                    @php
                                                    ...
                                                    @foreach ($cates as $item)
                                                        <option value="{{ $item->id }}"
                                                            @if (old('category_parent') == null && old('category_parent') == '')
                                                                {{$item->id == $product->productCategory->parentCategories->id ? 'selected' : ''}}
                                                            @endif
                                                            >
                                                            {{ $item->name }}
                                                        </option>
                                        ...
                                        <div class="col-md-12">
                                            <select class="selectpicker form-control" name="product_calculation_unit"
                                                ...
                                                @foreach ($calculationUnits as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (old('product_calculation_unit') != null && old('product_calculation_unit') != '')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" step="0.1" min="0.1" name="price_ctv"
                                                class="form-control" required
                                                value="{{ old('price_ctv', $product->productPrice->price_ctv) }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" step="0.1" min="0.1" name="price_vip"
                                                class="form-control" required
                                                value="{{ old('price_vip', $product->productPrice->price_vip) }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" step="0.1" min="0.1" name="nao_point"
                                                class="form-control" required
                                                value="{{ old('nao_point', $product->productPrice->nao_point) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
